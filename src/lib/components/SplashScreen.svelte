<script lang="ts">
    ...
    const PATHS = [
        ...
        {
            d: "M4372.97 3490.7C4372.97 3490.7 4387.12 3547.63 4485.18 3548.67H4559.7C4559.7 3548.67 4598.03 3546.91 4600.42 3571.81C4602.88 3596.63 4578.69 3601.79 4559.06 3602.5C4539.34 3603.21 4482.4 3602.5 4482.4 3602.5C4482.4 3602.5 4607.71 3613.57 4679.93 3689.49L4641.28 3636.06C4641.28 3636.06 4675.79 3618.17 4673 3570.77C4670.3 3523.37 4621.16 3491.09 4563.36 3490.7H4372.97Z",
    ...
    onMount(() => {
        // Pre-calculate random entry params for each path
        animatedPaths = PATHS.map((p) => {
...
{#if visible}
    ...
    >
        <div
            class="w-full max-w-4xl relative pointer-events-none"
            out:scale={{ start: 1.1, duration: 800 }}
        >
            <svg
                class="w-full h-auto drop-shadow-red"
                viewBox="0 0 6144 3868"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            >
                {#each animatedPaths as path}
                    <path d={path.d} fill={path.fill} in:fly={path.flyParams} />
                {/each}

                <defs>
                    <!-- Defs remain unchanged -->
                    <linearGradient
